            ...
            <form class="form" action="{{route('save')}}" method="POST">
              ...
              <div class="row mb-4">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <input type="email" name="email" value="" class="form-control form-control-lg" placeholder="Your Email*">
                </div>
              </div>
              <div class="row mb-4">
                <div class="col-lg-6 col-md-6 col-sm-12 mb-2">
              ...
              <div class="row">
                <input type="submit" name="submit" class="form-control form-control-lg text-light subit">
              </div>
            </form>
          </div>
        </div>
